...
class FinancialClass
{
     ...
     * @param int    $number   is the value used to increment datepart. If you specify a value that is not an integer, the fractional part of the value is discarded.
     * @param int    $date     a Unix timestamp value.
     *
     ...
     * @param int    $startdate is the beginning date (Unix timestamp) for the calculation.
     * @param int    $enddate   is the ending date (Unix timestamp) for the calculation.
     *
     * @return int the number between the two dates.
     */
     ...
     *
     * @param int  $start_date is the beginning date (Unix timestamp) for the calculation.
     * @param int  $end_date   is the ending date (Unix timestamp) for the calculation.
     * @param bool $method     is a logical value that specifies whether to use the U.S. or European method in the calculation.
     *
     * @return int the number of days between two dates based on a 360-day year
     */
     ...
     * @param int   $fraction          is the integer to use in the denominator of the fraction.
     *
     ...
     * @param int   $per     is the period and must use the same units as life.
     */
     ...
     * @param int   $nper is the total number of periods.
     *
     ...
     *
     * @param float $rate is the interest rate per period.
     * @param int   $nper is the total number of payment periods in an annuity.
     ...
     * @param int   $type is the number 0 or 1 and indicates when payments are due.
     *
