<head>
  ...
  <title>Credifort - @yield('title', '')</title>
  <meta name="description" content="Empresa 100% dedicada al otorgamiento de creditos sobre nómina y personales, con un servicio personalizado y eficiente, para obtener tu dinero de la manera más rapida." />
  <meta name="author" content="dinkbit" />
  <meta name="keywords" content="crédito, crédito sobre nómina, nómina, nomina, credito, consumo, sofom, enr, crédito personal">

  @yield('meta')

  <meta property="og:locale" content="es_LA" />
  <meta property="og:title" content="Credifort" />
  <meta property="og:description" content="Empresa 100% dedicada al otorgamiento de creditos sobre nómina y personales, con un servicio personalizado y eficiente, para obtener tu dinero de la manera más rapida." />
  <meta property="og:url" content="{{{ Request::url() }}}" />
  <meta property="og:site_name" content="Credifort" />
